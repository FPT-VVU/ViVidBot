        ...
        try:
            ...
            if "image" in sources[0]:
                ...
                if isinstance(self.list_data_dict[i]["image"], list):
                    ...
                    cur_token_len = (image[0].shape[1] // 14) * (
                        image[0].shape[2] // 14
                    )
                    ...
                    if os.path.exists(img_path):
                        ...
                        image = load_image_hf(
                            repo_id="Vividbot/instruct500k_vi", hf_image_path=image_file
                        )
                ...
                if "source" in self.list_data_dict[i]:
                    ...
                    video_folder = (
                        self.multimodal_cfg["video_folder"] + "/" + video_file_source
                    )
                else:
                ...
                if os.path.exists(video_path):
                    ...
                    video = load_video_hf(
                        repo_id="Vividbot/vast2m_vi", hf_video_path=video_file
                    )
                # print(video.shape)
