...
The description should first introduce the general context of the video, then describe the main objects, actions, and interactions in the video through time.
