...
with open(f"{Path.home()}/data/vietnamese_tiny_cot_alpaca_raw.json", "rb") as f:
  ...
  for i in tqdm(range(20000)):
    while True:
      ...
      # print(item)
      human_message = item["instruction_vi"]
      gpt_message = item["output_vi"]
...
with open(f"{Path.home()}/data/vietnamese_tiny_cot_alpaca.json", "w") as f:
